		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Se ha generado una nueva solicitud de viáticos generales en el sistema.</p>
					<p>Para aprobar o gestionar esta solicitud, por favor haz clic en el siguiente botón: </p>
					<p class="x_text_white">
					<a href="<?= $data['url_recovery']; ?>" target="_blank" class="x_button_link x_link_blue">Gestionar Solicitud</a>
					</p>
					<br>
