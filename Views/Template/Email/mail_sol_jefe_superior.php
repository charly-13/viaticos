		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Se ha registrado una nueva <strong>solicitud de viáticos</strong> pendiente de su aprobación o rechazo.</p>
					<p>Por favor, haga clic en el siguiente botón para revisar y gestionar la solicitud:</p>
