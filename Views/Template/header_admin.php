...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="https://ldrhsys.ldrhumanresources.com/Cliente/img/logos/LDR-blanco-Logo.png">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Viáticos</a>
